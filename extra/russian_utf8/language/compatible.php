...
if (!defined('_AM_RSSC_FORM_HTMLOUT')) {
    ...
    define(
        ...
        "При обработке содержимого, когда 'Использовать HTML теги в содержании' - 'Да'<br>Все теги удаляются, когда 'Нет' <br>это рекомендуется для удаления или замены JavaScript и связей, чтобы предотвратить XSS (Перекрестные сценарии сайта - Cross Site Scripting) "
    );
