...
if (!class_exists('rssc_view_param')) {
    ...
    class rssc_view_param extends happy_linux_rss_viewer
    {
        ...
        /**
         * @param null $dirname
         * @return \happy_linux_rss_viewer|\rssc_view_param|static
         */
        ...
        public function fetch_tpl_feed_list($param)
        {
            ...
            if (file_exists($dir_theme . '/rssc_feed_list.tpl')) {
                $template = $dir_theme . '/rssc_feed_list.tpl';
            } else {
