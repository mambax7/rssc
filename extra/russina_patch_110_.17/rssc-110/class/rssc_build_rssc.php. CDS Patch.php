...
// $Id: rssc_build_rssc.php.\040CDS\040Patch.php,v 1.1 2012/04/08 23:42:20 ohwada Exp $
...
if (!class_exists('rssc_build_rssc')) {
    ...
    class rssc_build_rssc extends happy_linux_build_rss
    {
        ...
        public function __construct($dirname)
        {
            ...
            if (file_exists($dir_theme . '/rssc_build_rdf.tpl')) {
                $this->set_rdf_template($dir_theme . '/rssc_build_rdf.tpl');
            } else {
                $this->set_rdf_template($DIR_XML . '/rssc_build_rdf.tpl');
            }
            if (file_exists($dir_theme . '/rssc_build_rss.tpl')) {
                $this->set_rss_template($dir_theme . '/rssc_build_rss.tpl');
            } else {
                $this->set_rss_template($DIR_XML . '/rssc_build_rss.tpl');
            }
            if (file_exists($dir_theme . '/rssc_build_atom.tpl')) {
                $this->set_atom_template($dir_theme . '/rssc_build_atom.tpl');
            } else {
        ...
        /**
         * @param null $dirname
         * @return \happy_linux_build_rss|\rssc_build_rssc|static
         */
