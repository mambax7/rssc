<{* $Id: rssc_block_feed_list.html.\040CDS\040Patch.html,v 1.1 2012/04/08 23:42:20 ohwada Exp $ *}>
...
<ul>
    ...
    <{$smarty.const._RSSC_IN}> <a href="<{$feed.site_link_s}>" target="_blank"><{$feed.site_title_s}></a>
    <{/if}>
