...
// $Id: parse_rss.php.\040CDS\040Patch.php,v 1.1 2012/04/08 23:42:20 ohwada Exp $
...
class admin_parse_rss extends happy_linux_error
{
    ...
    public function __construct()
    {
        ...
        if (file_exists($dir_theme . '/rssc_build_rdf.tpl')) {
            $this->TEMPLATE_RDF = $dir_theme . '/rssc_view_rdf.tpl';
        } else {
            $this->TEMPLATE_RDF = RSSC_ROOT_PATH . '/templates/xml/rssc_view_rdf.tpl';
        }
        if (file_exists($dir_theme . '/rssc_view_rss.tpl')) {
            $this->TEMPLATE_RSS = $dir_theme . '/rssc_view_rss.tpl';
        } else {
            $this->TEMPLATE_RSS = RSSC_ROOT_PATH . '/templates/xml/rssc_view_rss.tpl';
        }
        if (file_exists($dir_theme . '/rssc_view_atom.tpl')) {
            $this->TEMPLATE_ATOM = $dir_theme . '/rssc_view_atom.tpl';
        } else {
...
class admin_form_rss extends happy_linux_form
{
    ...
    /**
     * @return \admin_form_rss|\happy_linux_form|\happy_linux_html|static
     */
    public static function getInstance()
    {
        static $instance;
