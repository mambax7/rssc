...
';
        ...
        $arr = [
            ...
            'site_link'        => 'https://exsample.com/',
            'title'            => 'exsample',
            'link'             => 'https://exsample.com/exsample.html',
            ...
            'author_uri'       => 'https://exsample.com/author.html',
            'author_email'     => 'webmaster@exsample.com',
            'type_cont'        => '',
            'raws'             => '',
            'search'           => 'this is search field',
            'enclosure_url'    => 'https://exsample.com/exsample.mp3',
