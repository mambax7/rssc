...
if (!defined('RSSC_LANG_AM_LOADED')) {
    ...
    define(
        '_AM_RSSC_CONF_BLACK_USE_DESC',
        "Ne pas enregistrer si pr&eacute;sence dans la liste noire<br>When select \"Use\", interrupt filtering process, if judge black<br>When select \"Learning\", continue filtering process, for purpose extracting words, if judge black');define('_AM_RSSC_CONF_BLACK_USE_NO','Ne pas utiliser"
    );
    ...
    define(
        '_AM_RSSC_CONF_WORD_AUTO_DESC',
        'Extrait les mots dans le contenu automatiquement, et ajouter les mots dans la liste des mots rejet&eacute;s automatiquement, si les mots sont jug&eacute;s non d&eacute;sir&eacute;s<br><b>Attention</b> "point" est &agrave; 0<br>Changer "point" si utilisation'
    );
