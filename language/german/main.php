...
if (!defined('RSSC_LANG_MB_LOADED')) {
    ...
    // 2006-04-16 K.OHWADA
    define('_RSSC_NO_HEADLINK', 'Es gibt keinen ausgew�hlten Schlagzeilen Link');
    ...
    define('_RSSC_ENCLOSURE_LENGTH', 'Anlage Gr��e');
    // === 2006-09-01 ===
    // conflict with weblinks
    //if( !defined('_SAVE') )
    //{
    ...
    define('_RSSC_PARSE_NOT_READ_XML_URL', 'RSS Parse nicht m�glich: kann RSS url nicht lesen');
    ...
    define('_RSSC_ACT_NON', 'Ung�ltig');
    define('_RSSC_ACT_ACT', 'G�ltig');
    ...
    define('_RSSC_LINK_CENSOR', 'W�rter im Titel zu zensieren');
