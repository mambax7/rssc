...
if (!defined('RSSC_LANG_AM_LOADED')) {
    ...
    define('_AM_RSSC_ADD_LINK', 'Link hinzuf�gen');
    define('_AM_RSSC_ADD_BLACK', 'Blackliste hinzuf�gen');
    define('_AM_RSSC_ADD_WHITE', 'Whiteliste hinzuf�gen');
    define('_AM_RSSC_ADD_KEYWORD', 'Keyword hinzuf�gen');
    ...
    define('_AM_RSSC_DBUPDATED', 'Datenbank Updated vollst�ndig!');
    define('_AM_RSSC_FAILUPDATE', 'Fehler beim Speichern in die Datenbank');
    define('_AM_RSSC_FAILDELETE', 'Fehler beim L�schen aus der Datenbank');
    ...
    define('_AM_RSSC_DEL_LINK', 'L�schen Link');
    define('_AM_RSSC_SHOW_RSS', 'Ansicht RSS');
    define('_AM_RSSC_SHOW_FEED', 'Ansicht Eingabe');
    define('_AM_RSSC_FEED_BELONG_LINK', 'Ansicht-Eingabe Zugeh�rigkeit zu diesem Link');
    ...
    define('_AM_RSSC_MOD_BLACK', '�ndern Blacklist');
    define('_AM_RSSC_DEL_BLACK', 'L�schen Blacklist');
    define('_AM_RSSC_FEED_MATCH_LINK', 'RSS-Feeds anzeigen, in dieser Liste');
    // === white list manage ===
    define('_AM_RSSC_WHITE_MANAGE', 'Whitelist Managemnet');
    define('_AM_RSSC_MOD_WHITE', '�ndern Whitelist');
    define('_AM_RSSC_DEL_WHITE', 'L�schen Whitelist');
    // === feed list manage ===
    define('_AM_RSSC_ADD_FEED', 'Hinzuf�gen Feed');
    define('_AM_RSSC_MOD_FEED', '�ndern Feed');
    define('_AM_RSSC_DEL_FEED', 'L�schen Feed');
    ...
    define('_AM_RSSC_REFRESH_NEXT', '�berpr�fe n�chste %s');
    define('_AM_RSSC_LINK_LIMIT', 'Link Limit');
    define('_AM_RSSC_LINK_OFFSET', 'Link Offset');
    define('_AM_RSSC_FEED_CLEAR', 'Archive s�ubern');
    define('_AM_RSSC_FEED_CLEAR_OLD', '�ltere s�ubern');
    define('_AM_RSSC_FEED_CLEAR_NUM', 'L�scht die �lteren Aufzeichnungen, wenn mehr als die angegebene Zahl');
    // refresh result
    define('_AM_RSSC_NO_REFRESH', 'Kein Link ver�ndert');
    ...
    define('_AM_RSSC_NUM_LINK_UPDATED', 'Die Anzahl der ver�nderten-Links');
    define('_AM_RSSC_NUM_FEED_UPDATED', 'Die Anzahl der aktualisierten Eingaben');
    define('_AM_RSSC_NUM_FEED_CLEARED', 'Die Anzahl der gel�schten Eingaben');
    ...
    define('_AM_RSSC_CONF_FEED_LIMIT_DESC', 'Geben Sie die maximale Anzahl von RSS-Feeds in Feed-Tabelle<br>die �lteren L�schen,sobald sie mehr als dieser Wert<br><b>0</b> ist es unbegrenzt');
    define('_AM_RSSC_CONF_RSS_ATOM', 'Makiere RSS or ATOM');
    define('_AM_RSSC_CONF_RSS_ATOM_DESC', 'W�hlen Sie RSS oder ATOM, wenn beide RSS-und ATOM-URL URL entdeckt worden sind');
    define('_AM_RSSC_CONF_RSS_ATOM_SEL_ATOM', 'ATOM');
    define('_AM_RSSC_CONF_RSS_ATOM_SEL_RSS', 'RSS');
    define('_AM_RSSC_CONF_RSS_PARSER', 'W�hlen Sie RSS paser');
    define('_AM_RSSC_CONF_RSS_PARSER_SELF', 'RSSC parser');
    define('_AM_RSSC_CONF_RSS_PARSER_XOOPS', 'XOOPS RSS Parser');
    define('_AM_RSSC_CONF_ATOM_PARSER', 'W�hle ATOM parser');
    ...
    define('_AM_RSSC_CONF_FUTURE_DAYS_DESC', 'Eine Einheit ist ein Tag<br>Feed nicht anzeigen,wenn er nicht mit den Tagen �bereinstimmt');
    // show configuration
    ...
    define('_AM_RSSC_CONF_SHOW_ORDER_PUBLISHED', 'Letzte Ver�ffentlichung');
    ...
    define('_AM_RSSC_NOT_SELECT_LINK', 'Der Link ist nicht ausgew�hlt');
    define('_AM_RSSC_PLEASE_SELECT_LINK', 'W�hle Link aus der Liste,oder w�hle LINK ID');
    ...
    define('_AM_RSSC_VIEW_TITLE_HTML_DESC', 'Wenn ja ausgew�hlt, zeigen inclusive HTML tags. <br>Wenn nein ausgew�hlt, ohne HTML tags zeigen. ');
    define('_AM_RSSC_VIEW_CONTENT_HTML', 'Zeigen HTML Tags Inhalt');
    define('_AM_RSSC_VIEW_CONTENT_HTML_DESC', 'Wenn ja ausgew�hlt, zeigen inclusive HTML tags. <br>Wenn nein ausgew�hlt, ohne HTML tags zeigen. ');
    ...
    define('_AM_RSSC_VIEW_FORCE_DISCOVER_DESC', '�berschreiben RDF/RSS/ATOM URL,wenn diese URL nicht im Zusammenhang mit RSS-Modus steht');
    define('_AM_RSSC_VIEW_FORCE_UPDATE', 'Force update Archiv');
    define('_AM_RSSC_VIEW_FORCE_UPDATE_DESC', '�berschreiben Archiv, wenn RDF/RSS/ATOM nicht im Zusammenhang mit Refresh-Intervall');
    define('_AM_RSSC_VIEW_FORCE_OVERWRITE', 'Force update Feed table');
    define('_AM_RSSC_VIEW_FORCE_OVERWRITE_DESC', 'Overwrite Feed, auch wenn es die f�r die gleichen Daten RDF/RSS/ATOM URL');
    define('_AM_RSSC_VIEW_PRINT_LOG', 'Anzeige Log');
    define('_AM_RSSC_VIEW_PRINT_LOG_DESC', 'Anzeige Log gleichzeitig w�hrend der Ausf�hrung');
    define('_AM_RSSC_VIEW_PRINT_ERROR', 'Anzeige Fehler');
    define('_AM_RSSC_VIEW_PRINT_ERROR_DESC', 'Anzeige Fehler gleichzeitig w�hrend der Ausf�hrung');
    // === command manage ===
    ...
    define('_AM_RSSC_ID_DESC', 'ID �bertragung');
    // === 2006-06-04 ===
    // build rss
    ...
    define('_AM_RSSC_CONF_INDEX_DESC_DSC', 'Beschreibung wenn Sie m�chten, um auf die Hauptseite zu gelangen.');
    define('_AM_RSSC_CONF_INDEX_DESC_DEFAULT', '<div align="center" style="color: #0000ff">Hier sind Beschreibung zu     beachten.<br>Sie k�nnen Beschreibung bearbeiten unter "Module Konfiguration".<br></div><br>');
    // link table
    define('_AM_RSSC_LINK_DESC', 'Finden <b>RDF/RSS/ATOM URL</b> automatisch erkennen <b>Encoding</b> wenn nicht ausgef�llt <br>bzw. bei Fehler, <br>Support aufsuchen "RSS Auto Discovery"');
    ...
    define('_AM_RSSC_CONF_SHOW_CONTENT_HTML', 'HTML Tag nutzen f�r Content');
    ...
    define('_AM_RSSC_CONF_PROXY_USER_DESC', 'Geben Sie Benutzernamen, wenn der Proxy-Server-Authentifizierung ben�tigt BASIC, <br>wenn nicht frei lassen');
    define('_AM_RSSC_CONF_PROXY_PASS', 'Proxy Password');
    define('_AM_RSSC_CONF_PROXY_PASS_DESC', 'Geben Sie das Passwort ein, wenn der Proxy-Server-Authentifizierung ben�tigt BASIC, <br>wenn nicht bleibt leer');
    ...
    define('_AM_RSSC_ADD_WORD', 'verbotene Worte einf�gen');
    define('_AM_RSSC_MOD_WORD', 'verbotene Worte �ndern');
    define('_AM_RSSC_DEL_WORD', 'verbotene Worte l�schen');
    ...
    define('_AM_RSSC_CONF_WHITE_USE_DESC', 'Gespeichert, wenn in der wei�en Liste');
    define('_AM_RSSC_CONF_BLACK_USE', 'Benutze Black Liste');
    define('_AM_RSSC_CONF_BLACK_USE_DESC', 'Nicht speichern, wenn in der schwarzen Liste <br> Wenn Sie "Use", Interrupt-Filter-Prozess, wenn Richter schwarz <br> Wenn Sie "lernen", weiterhin Filter-Prozess, f�r den Zweck Extraktion Worten, wenn Richtung schwarz');
    define('_AM_RSSC_CONF_BLACK_USE_DESC', 'Nicht speichern, wenn in der schwarzen Liste <br> Wenn Sie "Use", Interrupt-Filter-Prozess, wenn Richter schwarz <br> Wenn Sie "lernen", weiterhin Filter-Prozess, f�r den Zweck Extraktion Worten, wenn Richtung schwarz');
    ...
    define('_AM_RSSC_CONF_WORD_USE_DESC', 'Nicht gespeichert wenn insgesamt Worte Liste �bersteigen dann Stufe nablehnen');
    define('_AM_RSSC_CONF_WORD_LEVEL', 'abgelehntes Stufe');
    define('_AM_RSSC_CONF_FEED_SAVE', 'Eingabe speichern');
    define('_AM_RSSC_CONF_FEED_SAVE_DESC', 'Wenn insgesamt der Wort-Liste �bersteigen ablehnen Ebene');
    ...
    define('_AM_RSSC_CONF_WHITE_COUNT_DESC', 'Vorrangig mit passenden Datensatz, wenn in der wei�en Liste');
    ...
    define('_AM_RSSC_CONF_WORD_COUNT_DESC', 'Z�hlen Sie die passenden Eintr�ge mit ablehnen, wenn in der Wort-Liste');
    define('_AM_RSSC_CONF_BLACK_AUTO', 'In die Black Liste einf�gen');
    define('_AM_RSSC_CONF_BLACK_AUTO_DESC', 'URL hinzuf�gen in schwarzen Liste automatisch<b> <br> </ b> "Status" ist als "ung�ltig" <br> Bitte �ndern Sie in "g�ltig", wenn Sie');
    define('_AM_RSSC_CONF_WORD_AUTO', 'In die Bad Word Liste einf�gen');
    define('_AM_RSSC_CONF_WORD_AUTO_DESC', 'Auswahl W�rter in der Content automatisch, und f�gen Sie W�rter in Wort ablehnen Liste automatisch<b> <br> </ b> "point" ist als Null <br> Bitte �ndern "point", wenn Sie');
    define('_AM_RSSC_CONF_WORD_AUTO_NON', 'Nicht eingef�gt');
    ...
    define('_AM_RSSC_CONF_JOIN_PREV_DESC', 'Gehe vor und zur�ck, und bilden Sie eine Phrase');
    ...
    define('_AM_RSSC_CONF_WORD_LIMIT_DESC', 'Geben Sie die maximale Anzahl der gespeicherten Wort in Wort Tisch <br> L�scht den �lteren Aufzeichnungen, sobald sie mehr als dieser Wert <b> 0 <br> </ b> ist umlimited');
    define('_AM_RSSC_KAKASI_EXECUTABLE', 'kakasi ist ausf�hrbar');
    define('_AM_RSSC_KAKASI_NOT_EXECUTABLE', 'kakasi ist nicht ausf�hrbar');
    define('_AM_RSSC_CONF_HTML_GET', 'HTML');
    define('_AM_RSSC_CONF_HTML_GET_DESC', 'Sie Herkunft HTML-Daten automatisch, wenn Richter ablehnen Wort Liste <br> Wenn Sie "Use", die Pr�zision des Urteils wird verbessert, aber die Ausf�hrung lange Zeit geworden');
    ...
    define('_AM_RSSC_CONF_HTML_LIMIT_DESC', 'Die maxmum Reihe von HTML-Zeichen, die sich automatisch <br> An einigen Standorten ist die gro�e HTML-Daten, und dann ist die Ausf�hrung lange Zeit geworden');
    // archive manage
    define('_AM_RSSC_LEAN_BLACK', 'Black List erlermen');
    define('_AM_RSSC_LEAN_BLACK_DESC', 'Patrol in die schwarze Liste, f�r die Zwecke Extrahieren W�rter in der Content automatisch, und das Hinzuf�gen von W�rtern in der Liste automatisch ablehnen Wort');
    ...
    // link table
    define('_AM_RSSC_LINK_CENSOR_DESC', 'Trennen Sie die einzelnen mit einem <b> | </ b> <br> Gro�-und Kleinschreibung');
}
// --- define language begin ---
