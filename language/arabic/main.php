...
if (!defined('RSSC_LANG_MB_LOADED')) {
    ...
    define('_RSSC_SEARCH', '���');
    define('_RSSC_LATEST_FEEDS', '��� RDF/RSS/ATOM Feeds');
    ...
    // link table item
    define('_RSSC_LINK_ID', '��� ������');
    define('_RSSC_USER_ID', '��� �����');
    define('_RSSC_MOD_ID', '��� �������');
    define('_RSSC_LTYPE', '���');
    define('_RSSC_REFRESH_INTERVAL', '���� �������');
    define('_RSSC_HEADLINE_ORDER', '������ �� �������� �������� ��� ���(0) ���� ��� �� ��������');
    define('_RSSC_ENCODING', '�������');
    define('_RSSC_RDF_URL', '���� RDF');
    define('_RSSC_RSS_URL', '���� URL');
    ...
    // for other module
    define('_RSSC_RSSC_LID', '��� ������ ������� RSSC');
    define('_RSSC_RSSC_LID_UPDATE', '����� ��� ������ ������� RSSC');
    define('_RSSC_GOTO_RSSC_ADMIN_LINK', '������ ��� ���� ������ ��������');

    // === 2007-06-01 ===
    // word table
    define('_RSSC_WORD_ID', '��� ������');
