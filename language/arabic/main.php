...
define('_RSSC_SEARCH','ÈÍË');
define('_RSSC_LATEST_FEEDS','ÂÎÑ RDF/RSS/ATOM Feeds');
define('_RSSC_THEREARE','íæÌÏ <b>%s</b> ÚäæÇä');

// headline
define('_RSSC_HEADLINE','ÇáÚäÇæíä ÇáãÎÊÕÑÉ');
define('_RSSC_LASTUPDATE','ÂÎÑ ÊÍÏíË');

// single
define('_RSSC_SINGLE','ãáÝ Feed æÇÍÏ');

// common
define('_RSSC_SITE_TITLE','ÚäæÇä ÇáãæÞÚ');
define('_RSSC_SITE_LINK', 'ÑÇÈØ ÇáãæÞÚ');
...
// link table item
define('_RSSC_LINK_ID','ÑÞã ÇáÑÇÈØ');
define('_RSSC_USER_ID','ÑÞã ÇáÚÖæ');
define('_RSSC_MOD_ID','ÑÞã ÇáãæÏíá');
define('_RSSC_LTYPE','äæÚ');
define('_RSSC_REFRESH_INTERVAL','ÝÊÑÉ ÇáÊÍÏíË');
define('_RSSC_HEADLINE_ORDER','ÊÑÊíÈÉ Ýí ÇáÚäÇæíä ÇáãÎÊÕÑÉ ÅÐÇ ßÇä(0) íÙåÑ ÝÞØ Ýí ÇáÑÆíÓíÉ');
define('_RSSC_ENCODING','ÇáÊÑãíÒ');
define('_RSSC_RDF_URL', 'ÑÇÈØ RDF');
define('_RSSC_RSS_URL', 'ÑÇÈØ URL');
define('_RSSC_ATOM_URL','ÑÇÈØ ATOM');
define('_RSSC_RSS_MODE','äãØ RSS');
define('_RSSC_RSS_MODE_NON',  'ÈÏæä');
define('_RSSC_RSS_MODE_RDF',  'ÕíÛÉ RDF');
define('_RSSC_RSS_MODE_RSS',  'ÕíÛÉ RSS');
define('_RSSC_RSS_MODE_ATOM', 'ÕíÛÉ ATOM');
define('_RSSC_RSS_MODE_AUTO', 'ÊáÞÇÆí');

// feed table item
define('_RSSC_FEED_ID','ÑÞã Feed');
define('_RSSC_MODE_CONT','äãØ ÇáãÍÊæì');
define('_RSSC_RAWS','Raw Data');
define('_RSSC_SEARCH_FIELD','ÍÞá ÇáÈÍË');
...
// 2006-04-16 K.OHWADA
define('_RSSC_NO_HEADLINK','áíÓ åäÇß æÕáÉ ÚäæÇä ÈÇÑÒ ãÍÏÏ');
define('_RSSC_NO_FEED','áÇ ÊæÌÏ ÈíÇäÇÊ feed');

// === 2006-06-04 ===
// single link
define('_RSSC_SINGLE_LINK',  'ãæÞÚ æÇÍÏ');
define('_RSSC_SINGLE_LINK_UTF8', 'ãæÞÚ æÇÍÏ ÈÜ UTF-8');
...
// error message
define('_RSSC_DB_ERROR',           'ÎØÃ Ýí ÞÇÚÏÉ ÈíÇäÇÊ ÇáÈÑäÇãÌ');
define('_RSSC_DISCOVER_SUCCEEDED', 'äÌÍ Ýí ÇáÇßÊÔÇÝ ÇáÊáÞÇÆí áÜ RSS');
define('_RSSC_DISCOVER_FAILED',    'äÌÍ Ýí ÇáÇßÊÔÇÝ ÇáÊáÞÇÆí áÜ RSS');
...
define('_RSSC_REFRESH_ERROR', 'ÝÔá Ýí ÊÍÏíË RSS');
...
// for other module
define('_RSSC_RSSC_LID', 'ÑÞã ÇáÑÇÈØ áÈÑäÇãÌ RSSC');
define('_RSSC_RSSC_LID_UPDATE', 'ÊÍÏíË ÑÝã ÇáÑÇÈØ áÈÑäÇãÌ RSSC');
define('_RSSC_GOTO_RSSC_ADMIN_LINK', 'ÇáÐåÇÈ Çáí ÕÝÍÉ ÇáÇÏãä ááÈÑäÇãÌ');

// === 2007-06-01 ===
// word table
define('_RSSC_WORD_ID','ÑÞã ÇáßáãÉ');
define('_RSSC_WORD_WORD','ÑÝÖ ÇáßáãÉ');
define('_RSSC_WORD_POINT','Point');
define('_RSSC_ACT','ÇáÍÇáÉ');
define('_RSSC_ACT_NON','Invalid');
define('_RSSC_ACT_ACT','Valid');
define('_RSSC_REG','Expression of URL');
define('_RSSC_REG_NORMAL','ÚÇÏí');
define('_RSSC_REG_EXP','Regular Expression');
define('_RSSC_FREQ_COUNT','Frequency Count');

// feed table
define('_RSSC_FEED_ACT',     'ÇáÍÇáÉ');
define('_RSSC_FEED_ACT_NON', 'áÇ ÊÚÑÖ');
define('_RSSC_FEED_ACT_VIEW','ÚÑÖ');

// link table
define('_RSSC_LTYPE_NON','ÈÏæä ÊÍÏíË');
define('_RSSC_LTYPE_SEARCH','ÈÍË ãæÞÚ');
define('_RSSC_LTYPE_NORMAL','ÚÇÏí');

define('_RSSC_XML_URL','ÚäæÇä RDF/RSS/ATOM');
