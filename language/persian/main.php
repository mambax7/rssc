...
define('_RSSC_LATEST_FEEDS','تغذیه کننده های RDF/RSS/ATOM اخیر');
define('_RSSC_THEREARE','<b>%s</b> تغذیه کننده در پایگاه داده ها موجود است');
...
// single
define('_RSSC_SINGLE','تغذیه کننده ی تنها');
...
// feed table item
define('_RSSC_FEED_ID','ID  تغذیه کننده');
...
// refresh link
define('_RSSC_REFRESH_LINK', 'تازه کردن تغذیه کننده های RDF/RSS/ATOM');
...
define('_RSSC_REFRESH_LINK_FINISHED', 'تازه کردن تغذیه کننده ها به پایان رسید');
