...
if (!defined('RSSC_LANG_MB_LOADED')) {
    ...
    // detect encoding
    define('_RSSC_ASSUME_ENCODING', 'presumi xml encoding %s ,<br>perch� impossibile determinare automaticamente');
    ...
    define('_RSSC_LINK_NOT_EXIST', 'Non c\'� link corrispondente in modulo RSSC');
    define('_RSSC_LINK_EXIST_MORE', 'Ci sono due o pi� link che hanno stesso "RDF/RSS/ATOM URL"');
    define('_RSSC_LINK_ALREADY', 'Esiste gi� un link con questo "RDF/RSS/ATOM URL"');
