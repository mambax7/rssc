...
if (!defined('RSSC_LANG_AM_LOADED')) {
    ...
    define('_AM_RSSC_INIT_NOT', 'La tabella config non � inizializzata');
    define('_AM_RSSC_INIT_EXEC', 'Tabella config inizializzata');
    define('_AM_RSSC_VERSION_NOT', 'Non � la versione  %s');
    ...
    define('_AM_RSSC_FEED_CLEAR_OLD', 'Azzera record pi� vecchi');
    define('_AM_RSSC_FEED_CLEAR_NUM', 'Azzera record pi� vecchi, se eccedono il numero specificato');
    ...
    define('_AM_RSSC_CONF_FEED_LIMIT_DESC', 'Inserire il num. max di feed salvati in tabella feed<br>Azzera record pi� vecchi, quando sono pi� di questo valore<br><b>0</b> � illimitato');
    ...
    define('_AM_RSSC_CONF_FUTURE_DAYS_DESC', 'Misurato in giorni<br>Non mostrare feed, se la data del feed � in avanti pi� di questo valore');
    ...
    define('_AM_RSSC_CONF_SHOW_MAX_TITLE_DESC', 'I tag HTML vengono tolti se si eccede questo numero<br><b>-1</b> � illimitato');
    define('_AM_RSSC_CONF_SHOW_MAX_SUMMARY', 'Il num max di caratteri del Sommario');
    define('_AM_RSSC_CONF_SHOW_MAX_SUMMARY_DESC', '<b>-1</b> � illimitato');
    ...
    define('_AM_RSSC_NOT_SELECT_LINK', 'Il link non � selezionato');
    ...
    define('_AM_RSSC_VIEW_MODE_DESC', 'Non salvare in tabella, quando modo � 0');
    ...
    define('_AM_RSSC_VIEW_TITLE_HTML_DESC', 'Se si sceglie SI, mostra com\'� inclusi i tag HTML. <br>Se si sceglie NO, mostra privo di tag HTML. ');
    define('_AM_RSSC_VIEW_CONTENT_HTML', 'Mostra tag HTML del contenuto');
    define('_AM_RSSC_VIEW_CONTENT_HTML_DESC', 'Se si sceglie SI, mostra com\'� inclusi i tag HTML. <br>Se si sceglie NO, mostra privo di tag HTML. ');
    define('_AM_RSSC_VIEW_MAX_CONTENT', 'Il num. max di caratteri del contenuto');
    define('_AM_RSSC_VIEW_MAX_CONTENT_DESC', 'I tag HTML vengono tolti, se si eccede questo numero<br><b>-1</b> � illimitato');
    ...
    define('_AM_RSSC_CONF_INDEX_DESC_DEFAULT', '<div align="center" style="color: #0000ff">Questa � una nota descrittiva.<br>Puoi editare questa nota in "Configurazione Modulo".<br></div><br>');
    ...
    define('_AM_RSSC_CONF_SHOW_MAX_CONTENT_DSC', 'I tag HTML vengono tolti, se si eccede questo numero<br><b>-1</b> � illimitato');
    ...
    define('_AM_RSSC_WORD_ALREADY', 'Questa parola � gi� registrata');
    ...
    define('_AM_RSSC_CONF_LINK_USE_DESC', 'Salva se "Tipo" di tabella link � "Normale"');
    ...
    define('_AM_RSSC_CONF_WORD_LIMIT_DESC', 'Inserire num. max parole salvate in tabella parole<br>Azzera record pi� vecchi, se si supera questo valore<br><b>0</b> � illimitato');
    ...
    define('_AM_RSSC_CONF_HTML_LIMIT_DESC', 'Il num. max caratteri HTML ricavati automaticamente<br>In alcuni siti i dati HTML possono essere molti, e l\'esecuzione pu� rallentarsi');
    ...
    define('_AM_RSSC_NUM_FEED_SKIP', 'Il numero di feed gi� salvati');
