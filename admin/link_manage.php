...
class admin_manage_link extends admin_manage_base
{
    ...
    /**
     * @return \admin_manage_base|\admin_manage_link|\happy_linux_manage|static
     */
...
class admin_form_link extends happy_linux_form_lib
{
    ...
    /**
     * @return \admin_form_link|\happy_linux_form|\happy_linux_form_lib|\happy_linux_html|static
     */
    public static function getInstance()
    {
        static $instance;
