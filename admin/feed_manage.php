...
class admin_manage_feed extends admin_manage_base
{
    ...
    /**
     * @return \admin_manage_base|\admin_manage_feed|\happy_linux_manage|static
     */
...
class admin_form_feed extends happy_linux_form
{
    ...
    /**
     * @return \admin_form_feed|\happy_linux_form|\happy_linux_html|static
     */
    public static function getInstance()
    {
        static $instance;
