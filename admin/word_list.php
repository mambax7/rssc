...
class admin_list_word extends happy_linux_page_frame
{
    ...
    /**
     * @return \admin_list_word|\happy_linux_form|\happy_linux_html|\happy_linux_page_frame|static
     */
...
class admin_word_search_form extends happy_linux_form
{
    ...
    /**
     * @return \admin_word_search_form|\happy_linux_form|\happy_linux_html|static
     */
    public static function getInstance()
    {
        static $instance;
