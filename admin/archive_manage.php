...
class admin_manage_archive extends happy_linux_manage
{
    ...
    /**
     * @return \admin_manage_archive|\happy_linux_manage|static
     */
...
class admin_form_archive extends happy_linux_form_lib
{
    ...
    /**
     * @return \admin_form_archive|\happy_linux_form|\happy_linux_form_lib|\happy_linux_html|static
     */
    public static function getInstance()
    {
        static $instance;
