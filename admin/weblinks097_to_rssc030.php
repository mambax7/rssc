...
class admin_import_weblinks extends admin_import_base
{
    ...
    /**
     * @return \admin_import_weblinks|\rssc_import_handler|static
     */
    ...
    public function import_site()
    {
        ...
        foreach ($site_list as $site_url) {
            echo $i . ': ' . htmlspecialchars($site_url, ENT_QUOTES | ENT_HTML5);
            $i++;
    ...
    public function import_black()
    {
        ...
        foreach ($site_list as $site_url) {
            ...
            echo $i . ': ' . htmlspecialchars($url, ENT_QUOTES | ENT_HTML5) . " <br>\n";
    ...
    public function import_link()
    {
        ...
        while ($row2 = $this->_db->fetchArray($res2)) {
            ...
            echo $lid . ': ' . htmlspecialchars($title, ENT_QUOTES | ENT_HTML5);
