...
/** @var Rssc\Common\Configurator $configurator */
$configurator = new Rssc\Common\Configurator();

/** @var \XoopsModules\Rssc\Common\Migrate $migrator */
$migrator = new \XoopsModules\Rssc\Common\Migrate($configurator);
