...
if ('rss_cache_clear' == $op) {
    if (!$config_form->check_token()) {
        ...
        redirect_header('build_menu.php', 1, _HAPPYLINUX_CLEARED);
    }
} else {
    xoops_cp_header();
}
