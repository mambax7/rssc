...
//mb        $this->_DIR_PLUGINS      = 'modules/' . $dirname . '/plugins';
        $this->_DIR_PLUGINS      = 'modules/' . $dirname . '/class/Plugins';
        $this->_DIR_PLUGINS_DATA = $this->_DIR_PLUGINS . '/data';
//mb        $this->_DIR_PLUGINS_LANG = $this->_DIR_PLUGINS . '/language/' . $this->_system->get_language();
    }
