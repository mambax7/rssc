...
// $Id: SearchHandler.php,v 1.1 2011/12/29 14:37:14 ohwada Exp $
...
//=========================================================
class SearchHandler extends ViewParam
{
    // class instance
    public $_search;
    public $_post;
    ...
    public function __construct($dirname)
    {
        ...
        $this->_search = Happylinux\Search::getInstance();
        $this->_post   = Happylinux\Post::getInstance();

        $this->_search->set_lang_zenkaku(_HAPPYLINUX_ZENKAKU);
        $this->_search->set_lang_hankaku(_HAPPYLINUX_HANKAKU);
    }
