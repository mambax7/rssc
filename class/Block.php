...
//=========================================================
    ...
    class Block
    {
        ...
        public function show_headline($DIRNAME)
        {
            ...
            list(
                $show_short, $show_middle, $show_long
        ...
        {
            $dirname = $param['dirname'];
//            require_once XOOPS_ROOT_PATH . '/modules/' . $dirname . '/class/Rssc\Block_map.php';
            $map_class = BlockMap::getSingleton($dirname);
        ...
        public function fetch_tpl_feed_list($param)
        {
            ...
            $show_li  = !$show_icon;
            $template = XOOPS_ROOT_PATH . '/modules/' . $dirname . '/templates/parts/rssc_block_feed_list.tpl';
