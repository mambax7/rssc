...
//================================================================
    ...
    // class ConfigDefine
    //=========================================================
    class ConfigDefine extends Happylinux\ConfigDefineBase
    {
        //---------------------------------------------------------
        // constructor
        //---------------------------------------------------------
        ...
        public function &get_define()
        {
            ...
            $config[50]['catid']     = 2;
            $config[50]['title']     = '_HAPPYLINUX_CONF_BIN_PASS';
            ...
            $config[51]['catid']     = 2;
            $config[51]['title']     = '_HAPPYLINUX_CONF_BIN_SEND';
            ...
            $config[52]['catid']     = 2;
            $config[52]['title']     = '_HAPPYLINUX_CONF_BIN_MAILTO';
