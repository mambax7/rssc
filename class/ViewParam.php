...
// $Id: ViewParam.php,v 1.2 2012/04/08 23:42:20 ohwada Exp $
...
// class ViewParam
//=========================================================
class ViewParam extends Happylinux\RssViewer
{
    public $_DIRNAME;
    public $_MODULE_URL;
    public $_MODULE_DIR;
    ...
    public function __construct($dirname)
    {
        ...
        $this->_image_class   = Happylinux\ImageSize::getInstance();
    }
    ...
    public function &view_format_sanitize_single_feed($orig, $flag_sanitize = true)
    {
        ...
        $feed['thumb_url_s']  = happylinux_sanitize_url($thumb_url);
    ...
    public function &get_tpl_common_param()
    {
        $arr = [
            'lang_edit'             => _EDIT,
            'lang_home'             => _HAPPYLINUX_HOME,
            'lang_main'             => _HAPPYLINUX_MAIN,
            'lang_goto_admin'       => _HAPPYLINUX_GOTO_ADMIN,
            'lang_no_record'        => _HAPPYLINUX_NO_RECORD,
    ...
    public function fetch_tpl_feed_list($param)
    {
        ...
        $template = $this->_MODULE_DIR . '/templates/parts/rssc_feed_list.tpl';
